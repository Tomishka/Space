#класс для обработки данных (внесение/удаление записей, считывание информации о категориях из файла)
#можно сделать возможность заносить собственные категории (если нужны будут доп баллы)
# #импорт библиотеки для работы с файлом
# import pandas as pd
#
# def print_data():
#     top_players = pd.read_excel('/Users/tamarazhuk/Documents/КУРСАЧ ТП/DB/ФАЙЛ С ДАННЫМИ/Data copy.xlsx')
#     top_players.head()
...
# class BotDBExcel:
#     def __init__(self):
#         excel_file = "/Users/tamarazhuk/Documents/КУРСАЧ ТП/DB/ФАЙЛ С ДАННЫМИ/Data copy.xlsx"  # путь до файла
#
#     def print_data(self, top_players):
#         top_players.head()
#
# class BotDB:
#
#     def __init__(self, db_file):
#         #инициализируем файл, в котором будем работать
